    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="limit-box">
                        <nav class="menu">
                            <ul class="menu-bar">
                                ...
                                <li><a href="#Layanan">Trending</a></li>
                                <li><a href="#Paket">Health</a></li>
                                <li><a href="#Fasilitas">Sport</a></li>
                                <li><a href="#Fasilitas">Entertaiment</a></li>
                                <li><a href="#Fasilitas">Covid 19</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                <li class="login"><a href="#blank">Login</a></li>
            </div>
        </div>
    </div>
</header>
